...
public class WebMvcAutoConfiguration {
    ...
    public static class WebMvcAutoConfigurationAdapter implements WebMvcConfigurer {
        ...
        public void addResourceHandlers(ResourceHandlerRegistry registry) {
            ...
            //如果容器中有的话，加载classpath下 webjars/** ，例如加载jquery.js
            if (!registry.hasMappingForPattern("/webjars/**")) {
                customizeResourceHandlerRegistration(registry.addResourceHandler("/webjars/**")
                        .addResourceLocations("classpath:/META-INF/resources/webjars/")
                        .setCachePeriod(getSeconds(cachePeriod)).setCacheControl(cacheControl));
            }
            //获取静态资源默认映射路径，拿到staticPathPattern, 默认为/**
            String staticPathPattern = this.mvcProperties.getStaticPathPattern();
            if (!registry.hasMappingForPattern(staticPathPattern)) {
                customizeResourceHandlerRegistration(registry.addResourceHandler(staticPathPattern)//加载静态资源 staticPathPattern = /**
* 默认静态资源  this.resourceProperties.getStaticLocations()
...
*
             * 按照ctrl进入【getStaticLocations】方法可以看到返回到位置是
        ...
        public ContentNegotiationManager mvcContentNegotiationManager() {
            ...
            while (iterator.hasNext()) {
                ...
                if (strategy instanceof PathExtensionContentNegotiationStrategy) {
                    iterator.set(new org.springframework.boot.autoconfigure.web.servlet.WebMvcAutoConfiguration.OptionalPathExtensionContentNegotiationStrategy(strategy));
                }
            }
            return manager;
        }
    ...
    static class ResourceChainCustomizerConfiguration {
        ...
        @Bean
        org.springframework.boot.autoconfigure.web.servlet.WebMvcAutoConfiguration.ResourceChainResourceHandlerRegistrationCustomizer resourceHandlerRegistrationCustomizer() {
            return new org.springframework.boot.autoconfigure.web.servlet.WebMvcAutoConfiguration.ResourceChainResourceHandlerRegistrationCustomizer();
        }
    ...
    static class ResourceChainResourceHandlerRegistrationCustomizer implements org.springframework.boot.autoconfigure.web.servlet.WebMvcAutoConfiguration.ResourceHandlerRegistrationCustomizer {
